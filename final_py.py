...
import io
import base64
with open('C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/final_players.pkl','rb') as f:
    a=pkl.load(f)
...
w = pd.read_pickle("C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/winners.pkl")
#with open('C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/winners.pkl','rb') as f:
#    w=pkl.load(f)
f4 = pd.read_pickle("C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/final4.pkl")
#with open('C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/final4.pkl','rb') as f:
#   f4=pkl.load(f)
t4 = pd.read_pickle("C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/t4.pkl")
#with open('C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/t4.pkl','rb') as f:
#    t4=pkl.load(f)
cc = pd.read_pickle("C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/cc.pkl")
#with open('C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/cc.pkl','rb') as f:
#    cc=pkl.load(f)
oandp = pd.read_pickle("C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/oandp.pkl")
orange=oandp['orange']
purple=oandp['purple']
#with open('C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/oandp.pkl','rb') as f:
#    oandp=pkl.load(f)
maxs = pd.read_pickle("C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/max_score.pkl")
...
#    maxs=pkl.load(f)
#    maxs['Max_score']=maxs['Max_score'].map(int)
mins = pd.read_pickle("C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/min_score.pkl")
#with open('min_score.pkl','rb') as f:
#    mins=pkl.load(f)
teamcomp = pd.read_pickle("C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/teamcomp.pkl")
#with open('teamcomp.pkl','rb') as f:
#    teamcomp=pkl.load(f)
points_nrr = pd.read_pickle("C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/points_nrr.pkl")
#with open('points_nrr.pkl','rb') as f:
#    points_nrr=pkl.load(f)
dept = pd.read_pickle("C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/dept.pkl")
#with open('dept.pkl','rb') as f:
#    dept=pkl.load(f)
comp = pd.read_pickle("C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/tvalllabel.pkl")
#with open('tvalllabel.pkl','rb') as f:
#    comp=pkl.load(f)
tl = pd.read_pickle("C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/team_late.pkl")
tl['wickets']=tl['wickets'].astype(np.int16)
#with open('team_late.pkl','rb') as f:
#    tl=pkl.load(f)
#    tl['wickets']=tl['wickets'].astype(np.int16)
d = pd.read_pickle("C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/deliveries.pkl")
#with open('deliveries.pkl','rb') as f:
#    d=pkl.load(f)
mp = pd.read_pickle("C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/matches_played.pkl")
...
def test():
    ...
    dt=datetime.now()
    print(player,dt)
    df=pd.read_csv('C:/Users/Sriraam/Downloads/ipl_final_completed/ipl_final_completed/check.csv')
    df['player']=player
    df['time']=dt
    print(df)
